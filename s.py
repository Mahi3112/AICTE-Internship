...
DEMO_IMAGE = r"C:\Users\mahid\OneDrive\Desktop\istockphoto-1214270214-612x612.jpg"
...
inWidth=width
inHeight=height
net = cv2.dnn.readNetFromTensorflow(r"C:\Users\mahid\Downloads\graph_opt.pb")

# Streamlit app title and instructions
st.title("Human Pose Estimation with OpenCV")
st.text("Upload an image with all body parts clearly visible for best results.")
...
def poseDetector(frame):
      ...
      net.setInput(cv2.dnn.blobFromImage(frame,1.0,(inWidth,inHeight),(127.5,127.5,127.5),swapRB=False, crop=False))
      out=net.forward()
      out=out[:,:19,:,:]
